 ...
 */
export const DIRECTION_SOUTH = 0;
export const DIRECTION_WEST = 1;
export const DIRECTION_NORTH = 2;
export const DIRECTION_EAST = 3;
...
// Fin du jeu, victoire ou game over
export const GAME_STATE_FIGHT = 2;
// Combat dragon <-> joueur
export const GAME_STATE_PLAY = 3;
// Le joueur est sur la carte
export const GAME_STATE_PLAY_START = 4;

// Le joueur est sur le point de départ sur la carte
/*
 ...
 */
export const ARMOR_COPPER = 'Armure en cuivre';
export const ARMOR_IRON = 'Armure en fer';
export const ARMOR_MAGICAL = 'Armure magique';

export const SWORD_WOOD = 'Epée en bois';
export const SWORD_STEEL = 'Epée en acier';
export const SWORD_EXCALIBUR = 'Epée Excalibur';

/*
 * Tableau des données
 */
export const TREASURE_TYPE_ARMOR = 1;
export const TREASURE_TYPE_SWORD = 2;

export var dataTreasures = new Array();
 ...
 */
export const TILESET_PIXEL_SIZE = 16;
...
export const TILE_HERB = 2;
export const TILE_MOUNTAIN = 3;
export const TILE_MOUNTAIN_NE = 4;
export const TILE_MOUNTAIN_NW = 5;
export const TILE_MOUNTAIN_SE = 6;
export const TILE_MOUNTAIN_SW = 7;
export const TILE_MOUNTAIN_TOP = 8;
export const TILE_ROCK1 = 9;
export const TILE_ROCK2 = 10;
export const TILE_STAIRS1 = 11;
export const TILE_STAIRS2 = 12;
export const TILE_STATUE1 = 13;
export const TILE_STATUE2 = 14;
export const TILE_TREE1 = 15;
export const TILE_TREE2 = 16;
export const TILE_WATER = 17;
export const TILE_WATER_E = 18;
export const TILE_WATER_N = 19;
export const TILE_WATER_NE = 20;
export const TILE_WATER_NW = 21;
export const TILE_WATER_S = 22;
export const TILE_WATER_SE = 23;
export const TILE_WATER_SW = 24;
export const TILE_WATER_W = 25;
 ...
 */
export var dataTiles = new Array();
 ...
 */
export const DRAGON_TYPE_GREEN = 'Dragon Vert';
export const DRAGON_TYPE_RED = 'Dragon Rouge';
export const DRAGON_TYPE_BLACK = 'Dragon Noir';
 ...
 */
export var dataDragons = new Array();

dataDragons[DRAGON_TYPE_GREEN] = {
  attackLevel: 8,
  defenseLevel: 10,
  agility: 5,
  hp: 180,
