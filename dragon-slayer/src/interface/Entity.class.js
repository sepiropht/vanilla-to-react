...
var Entity = function(fileName, height, animationFrameCount)
{
    ...
    this.x      = null;             // Au début l'entité est nulle part
...
Entity.prototype.refresh = function(canvasContext, world)
{
    ...
    x = this.x - world.offsetX;     // Coordonnée X relative au monde
    y = this.y - world.offsetY;     // Coordonnée Y relative au monde
    ...
    (
        ...
        this.sprite.sx,             // sx
        this.sprite.sy,             // sy
        TILESET_PIXEL_SIZE,         // sWidth  (16 pixels)
        TILESET_PIXEL_SIZE,         // sHeight (16 pixels)
        x * TILESET_PIXEL_SIZE,     // dx
        y * TILESET_PIXEL_SIZE,     // dy
        TILESET_PIXEL_SIZE,         // dWidth  (16 pixels)
        TILESET_PIXEL_SIZE          // dHeight (16 pixels)
    );
};
